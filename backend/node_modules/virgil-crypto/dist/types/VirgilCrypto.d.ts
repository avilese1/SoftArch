 ...
 */
export declare class VirgilCrypto {
    /**
     * Indicates whether to use old algorithm to calculate keypair identifiers.
     *
     ...
     */
    constructor({ useSha256Identifiers, defaultKeyPairType }?: VirgilCryptoOptions);
    /**
     ...
     */
    createStreamCipher(publicKey: VirgilPublicKey | VirgilPublicKey[]): VirgilStreamCipher;
    /**
     ...
     */
    createStreamVerifier(signature: Data, encoding: StringEncoding): VirgilStreamVerifier;
    /**
