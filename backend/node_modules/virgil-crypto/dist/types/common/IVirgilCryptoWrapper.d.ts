 ...
 * @hidden
 */
export declare type VerificationKey = {
    identifier?: Buffer;
    key: Buffer;
};
/**
...
export interface IVirgilCryptoWrapper {
     ...
     */
    signThenEncryptDetached(data: Buffer, privateKey: SigningKey, publicKeys: EncryptionKey[]): {
     ...
     */
    decryptThenVerifyDetached(encryptedData: Buffer, metadata: Buffer, privateKey: DecryptionKey, publicKeys: VerificationKey[]): Buffer;
    /**
